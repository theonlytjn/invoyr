...
export default function AdminUserDetailPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        <Link href="/admin/users" className="text-neutral-400 hover:text-neutral-950 dark:hover:text-neutral-50 text-sm">← Users</Link>
      </div>

      <h1 className="text-xl font-serif text-neutral-950 dark:text-neutral-50 mb-1">{user.email}</h1>
      ...
      {user.org && (
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 mb-6 space-y-3">
          ...
          <div className="pt-2">
            <Link href={`/admin/organisations/${user.org.id}`} className="text-neutral-500 hover:text-neutral-950 dark:hover:text-neutral-50 text-sm">
              Manage organisation →
            </Link>
          </div>
        </div>
