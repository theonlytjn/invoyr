    ...
    <div className="max-w-2xl mx-auto px-6 pt-24 pb-24">
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-neutral-900 border-y border-neutral-900">
        <div className="py-6 sm:pr-8">
          ...
          <p className="mt-2 text-sm text-neutral-500">For questions about features, plans, or how Invoyr works.</p>
          <a href="mailto:hello@invoyr.io" className="mt-2 inline-block text-sm text-neutral-100 hover:text-brand transition-colors">
            hello@invoyr.io
          </a>
        </div>
        <div className="py-6 sm:pl-8">
          <h2 className={KICKER}>Support</h2>
          <p className="mt-2 text-sm text-neutral-500">Already a customer and need help? We&apos;ve got you.</p>
          <a href="mailto:support@invoyr.io" className="mt-2 inline-block text-sm text-neutral-100 hover:text-brand transition-colors">
            support@invoyr.io
          </a>
        </div>
      </div>
