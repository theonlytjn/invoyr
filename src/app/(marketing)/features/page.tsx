    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-8 text-center">
        ...
        <div className="mt-9 flex items-center justify-center gap-4">
          ...
          <Link href="/pricing" className="text-base text-neutral-400 hover:text-neutral-100 transition-colors">
            View pricing →
          </Link>
        </div>
      </section>
        ...
        <div className={`${CONTAINER} py-20`}>
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-3">
            ...
            <div className={`relative flex flex-col overflow-hidden p-8 ${CARD}`}>
              ...
              <p className="mt-3 text-neutral-400 leading-relaxed">Your client taps the link and pays from their phone — card, PayPal or bank transfer.</p>
              ...
              <div className="absolute inset-x-0 top-44 flex justify-center">
                <div className="w-72 rounded-t-3xl border-8 border-b-0 border-neutral-800 bg-neutral-950 shadow-2xl shadow-black/60">
                  <div className="flex items-center justify-between px-5 pb-1 pt-3 font-mono text-[10px] text-neutral-400"><span>9:41</span><span>5G ▬▬▬</span></div>
                  <div className="px-5 pb-8 pt-2">
                    <div className="rounded-lg bg-neutral-900 px-4 py-3"><p className="font-serif text-base text-neutral-50">TJN Agency</p><p className="font-mono text-[10px] text-neutral-500">#INV-0042</p></div>
                    <div className="mt-4 flex items-baseline justify-between"><span className="text-xs text-neutral-500">Amount due</span><span className="font-serif text-2xl text-neutral-50">£6,000</span></div>
            ...
            <div className="flex flex-col gap-4">
              <div className={`flex flex-1 flex-col p-8 ${CARD}`}>
                ...
                <p className="mt-3 text-neutral-400 leading-relaxed">Net 7, 14, 30 or a custom due date — and recurring bills for retainers.</p>
                <div className="mt-6">
                  <p className="font-mono text-[10px] uppercase tracking-wide text-neutral-500">Payment terms</p>
              ...
              <div className={`flex flex-1 flex-col p-8 ${CARD}`}>
                ...
                <p className="mt-3 text-neutral-400 leading-relaxed">Invoice in any currency with the right VAT, ready for your accountant.</p>
        ...
        <div className={`${CONTAINER} py-20`}>
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-3">
            ...
            <div className={`flex flex-col p-8 ${CARD}`}>
              ...
              <p className="mt-3 text-neutral-400 leading-relaxed">Polite nudges at 7, 14 and 30 days overdue — sent in your name.</p>
              <div className="mt-6 flex items-center gap-2">
                {["7d", "14d", "30d"].map((d, i) => (
            ...
            <div className={`flex flex-col p-8 ${CARD}`}>
              ...
              <p className="mt-3 text-neutral-400 leading-relaxed">Revenue, ageing and top clients — see exactly where you stand.</p>
            ...
            <div className={`flex flex-col p-8 ${CARD}`}>
              ...
              <p className="mt-3 text-neutral-400 leading-relaxed">QuickBooks, Xero and CSV — one click, no reformatting.</p>
            ...
            <div className="flex">
              ...
              <div className="flex-1 p-6">
                ...
                <div className="mt-4 rounded-xl border border-neutral-900">
                  <div className="flex items-center justify-between border-b border-neutral-900 px-4 py-3"><span className="text-xs text-neutral-300">Latest invoices</span><span className="text-[10px] text-neutral-500">View all →</span></div>
                  {[
