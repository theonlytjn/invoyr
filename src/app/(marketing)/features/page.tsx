    ...
    <div>
      ...
      <section className="border-t border-neutral-200 dark:border-neutral-900">
        <div className={`${CONTAINER} py-20`}>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg text-neutral-600 dark:text-neutral-200">
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-3">
            ...
            <div className={`relative flex flex-col overflow-hidden p-8 ${CARD}`}>
              <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Get paid on the go</h3>
              <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">Your client taps the link and pays from their phone — card, PayPal or bank transfer.</p>
              <div className="h-80" aria-hidden />
              <div aria-hidden="true" className="absolute inset-x-0 top-44 flex justify-center">
                <div className="w-72 rounded-t-3xl border-8 border-b-0 border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-2xl shadow-neutral-900/10 dark:shadow-black/60">
                  <div className="flex items-center justify-between px-5 pb-1 pt-3 font-mono text-[10px] text-neutral-600 dark:text-neutral-200"><span>9:41</span><span>5G ▬▬▬</span></div>
                  <div className="px-5 pb-8 pt-2">
                    <div className="rounded-lg bg-neutral-100 dark:bg-neutral-900 px-4 py-3"><p className="font-serif text-base text-neutral-900 dark:text-neutral-50">Northbridge Creative Ltd</p><p className="font-mono text-[10px] text-neutral-500 dark:text-neutral-400">#INV-0042</p></div>
                    <div className="mt-4 flex items-baseline justify-between"><span className="text-xs text-neutral-500 dark:text-neutral-400">Amount due</span><span className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">£6,000</span></div>
            ...
            <div className="flex flex-col gap-4">
              <div className={`flex flex-1 flex-col p-8 ${CARD}`}>
                <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Your terms, your way</h3>
                <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">Net 7, 14, 30 or a custom due date — and recurring bills for retainers.</p>
                <div className="mt-6">
                  <p className="font-mono text-[10px] uppercase tracking-wide text-neutral-500 dark:text-neutral-400">Payment terms</p>
                  <div className="mt-1.5 flex items-center justify-between rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-4 py-3">
                    <span className="font-serif text-lg text-neutral-900 dark:text-neutral-100">Net 30</span>
              ...
              <div className={`flex flex-1 flex-col p-8 ${CARD}`}>
                ...
                <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">Invoice in any currency with the right VAT, ready for your accountant.</p>
            ...
            {/* Tall right — invoice */}
            <div className={`relative flex flex-col overflow-hidden p-8 ${CARD}`}>
              <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Invoices that look considered</h3>
              ...
              <div aria-hidden="true" className="absolute inset-x-8 top-44">
                <div className="rounded-t-xl border border-b-0 border-neutral-200 dark:border-white/10 bg-white dark:bg-neutral-950 p-6 shadow-2xl shadow-neutral-900/10 dark:shadow-black/60">
        ...
        <div className={`${CONTAINER} py-20`}>
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-3">
            ...
            <div className={`flex flex-col p-8 ${CARD}`}>
              <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Chase automatically</h3>
              <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">Polite nudges at 7, 14 and 30 days overdue — sent in your name.</p>
              <div className="mt-6 flex items-center gap-2">
                {["7d", "14d", "30d"].map((d, i) => (
                  <div key={d} className="flex items-center gap-2">
                    <span className="grid h-11 w-11 place-items-center rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 font-mono text-xs text-emerald-600 dark:text-emerald-400">{d}</span>
                    {i < 2 && <span className="h-px w-6 bg-neutral-200 dark:bg-neutral-800" />}
                  </div>
                ))}
                <span className="ml-auto font-mono text-[11px] text-neutral-500 dark:text-neutral-400">auto</span>
              </div>
            </div>

            {/* Reports */}
            <div className={`flex flex-col p-8 ${CARD}`}>
              <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Real reporting</h3>
              <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">Revenue, ageing and top clients — see exactly where you stand.</p>
            ...
            {/* Exports */}
            <div className={`flex flex-col p-8 ${CARD}`}>
              <h3 className="font-serif text-2xl text-neutral-900 dark:text-neutral-50">Export clean</h3>
              <p className="mt-3 text-neutral-600 dark:text-neutral-200 leading-relaxed">QuickBooks, Xero and CSV — one click, no reformatting.</p>
              <div className="mt-6 flex flex-wrap gap-2">
                {["QuickBooks", "Xero", "CSV"].map((x) => (
                  <span key={x} className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2 font-mono text-xs text-neutral-700 dark:text-neutral-300">{x}</span>
                ))}
              </div>
            </div>
          </div>
