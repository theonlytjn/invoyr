    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-8 text-center">
        ...
        <div className="mt-9 flex items-center justify-center gap-4">
          ...
          <Link href="/features" className="text-base text-neutral-200 hover:text-neutral-100 transition-colors">
            Explore features →
          </Link>
        </div>
      </section>
                ...
                <div className="mt-4 rounded-xl border border-neutral-900">
                  ...
                  {[
                    ...
                    <div key={num} className="flex items-center justify-between border-b border-neutral-900 px-4 py-3 text-xs last:border-b-0">
                      ...
                      <span className="w-24 text-right text-neutral-200">{amount}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-2">
            {USE_CASES.map((useCase) => (
              <div key={useCase.role} className={`${CARD} flex flex-col p-8`}>
                <h3 className="font-serif text-2xl text-neutral-50">{useCase.role}</h3>
                <p className="mt-3 text-lg text-neutral-200 leading-relaxed">{useCase.description}</p>
                <ul className="mt-6 space-y-3 border-t border-neutral-800 pt-6">
                  {useCase.benefits.map((b) => (
                    <li key={b} className="flex items-start gap-3 text-base text-neutral-300">
